            ...
            <main className="login-page-container">
              <form  onSubmit={handleSubmit}className="login-form">
                ...
                {state !== 'login' && (
                  ...
                  {state === 'login' 
                  ? (
                    <p className="mt-4 text-sm text-gray-500 dark:text-gray-400"> Don't have an account? <button 
                    onClick={() => setState('signup')} className="ml-1 cursor-pointer text-green-600 hover:underline">Sign up</button></p>
                    ) 
                    : 
                    (
